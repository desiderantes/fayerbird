 ...
 * @author mario
 */
public class TweetPanel extends javax.swing.JPanel implements ListCellRenderer {
	...
	public TweetPanel(Twitter twitter) {
		initComponents();
	...
	public Component getListCellRendererComponent(JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
		...
		URL imgURL = null;
		try {
			imgURL = new URL(status.getUser().getProfileImageURL());
