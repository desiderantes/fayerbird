 ...
 * @author desiderantes
 */
public class UserPanel extends javax.swing.JPanel implements ListCellRenderer {
	public UserPanel(){
		initComponents();
	}
	...
	public Component getListCellRendererComponent(JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
		...
		jLabel1.setText("@" + user.getScreenName());
		jLabel3.setText(user.getLocation() + "");
		jLabel.setText(user.getDescription());

		//AVATAR
		URL imgURL = null;
		try {
			imgURL = new URL(user.getProfileImageURL());
